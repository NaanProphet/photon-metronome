...
public class photon_metronome extends PApplet {
...
public HashMap<String, String> readProps(String[] in) {
...
public void draw()
{
  ...
  fill(200);
  textAlign(CENTER);
  text ("MIDI Visual Metronome", width * 0.5f, 75);
  text ("MIDI Sync Input Device: " + midiInput, width * 0.5f, 140);
  text ("Output IP Address: " + particleDevice, width * 0.5f, 165);
  text ("Output UDP Port: " + udpPort, width * 0.5f, 190);
  text ("version: " + version, width * .75f, 275);
}
...
public void sendData(float multiplier) {
...
private void setLED(int red, int green, int blue) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "photon_metronome" };
    if (passedArgs != null) {
